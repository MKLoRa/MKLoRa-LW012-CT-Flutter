  ...
  Future<void> _save() async {
    ...
    await runWithBleLoading(context, () async {
      ...
      final ok = (await Future.wait([
        api.writeFilterIbeaconUuid(Lw012ParamHelpers.hexToBytes(_uuid.text.trim())),
        api.writeFilterIbeaconMajorRange(majorRange),
        api.writeFilterIbeaconMinorRange(minorRange),
